...
import DatosHQL.ConfigHibernate;
...
public class Gestor {
    ...
    public List<Object> buscarPorAtributo(Session session, Class clase,
        ...
        consulta.setParameter("valor", valorAtributo, Hibernate.STRING); //ojo en intellij hay que poner StringType.INSTANCE en lugar de  HIBERNATE.STRING
        List<Object> lista;
        try {
            lista = consulta.list();
            return lista;
